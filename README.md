...
jobs:
  build-image:
    ...
    uses: ppat/github-workflows/.github/workflows/build-docker-image.yaml@v8.2.0 # x-release-please-version
    with:
      image_context_path: .
...
jobs:
  lint-yaml:
    uses: ppat/github-workflows/.github/workflows/lint-yaml.yaml@v8.2.0 # x-release-please-version
    with:
      git_ref: ${{ github.head_ref || github.ref }}
```
...
jobs:
  release:
    uses: ppat/github-workflows/.github/workflows/release-please.yaml@v8.2.0 # x-release-please-version
    secrets:
